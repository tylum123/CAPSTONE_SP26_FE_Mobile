      ...
      <ScrollView style={styles.container}>
          ...
          <View style={styles.headerOverlay}>
            <View style={styles.header}>
              <View style={styles.avatarSection}>
                <Avatar fallback={user?.name?.[0] || "T"} size={80} />
                <Text style={styles.name}>{user?.name || "tylum2901"}</Text>
                <Text style={styles.role}>Nông dân</Text>
              </View>
            </View>
            <TouchableOpacity
        ...
        <View style={styles.statsContainer}>
          ...
          <View style={styles.statItem}>
            ...
            <Text style={styles.statLabel}>Tin tuyển</Text>
          </View>
          <View style={styles.statItem}>
            <View style={styles.statIcon}>
          ...
          <CardContent>
            ...
            <View style={styles.infoRow}>
              ...
              <Text style={styles.infoText}>
                {user?.email || "tylum2901@email.com"}
              </Text>
            </View>
          </CardContent>
        </Card>
        ...
        <Card style={styles.card}>
          <CardContent>
            <Text style={styles.sectionTitle}>Loại hình canh tác</Text>
            <View style={styles.skillsContainer}>
              <View style={styles.skillBadge}>
                <Text style={styles.skillText}>Lúa nước</Text>
              </View>
              <View style={styles.skillBadge}>
                <Text style={styles.skillText}>Vườn cây ăn trái</Text>
              </View>
              <View style={styles.skillBadge}>
                <Text style={styles.skillText}>Rau màu</Text>
              </View>
            </View>
          </CardContent>
        </Card>
